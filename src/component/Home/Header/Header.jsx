...
const Header = () => {
  ...
  const words = [
    ...
    "Free Mystery Gift On All Orders Over £50",
    "15% Student Discount, Discover More",
  ];
  ...
  return (
    ...
    >
      <div
        ...
        className="d-flex my-2 justify-content-evenly"
      >
        <svg
      ...
      <p className="my-1" style={{ fontSize: "0.8rem", fontWeight: "bold" }}>
